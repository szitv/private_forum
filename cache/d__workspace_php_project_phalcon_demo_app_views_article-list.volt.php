...
<li>
    <a id="<?= $login_id ?>" href="javascript:void(0)">
        <img src="/images/placeholder/login.png" alt="<?= $login_title ?>" />
...
<li>
    ...
    <img src="/images/placeholder/markdown.png" alt="Markdown基础用法" />
...
<li>
    ...
    <img src="/images/placeholder/article.png" alt="写作文" />
...
<li>
    ...
    <img src="/images/placeholder/evmac.png" alt="易蚂蚁" />
